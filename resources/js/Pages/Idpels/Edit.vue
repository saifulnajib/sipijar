...
const form = useForm({
    idpel_number: props.idpel.idpel_number,
    name: props.idpel.name,
    address: props.idpel.address || '',
    district_id: props.idpel.district_id || '',
    status: props.idpel.status,
    lat: props.idpel.lat || '',
    lng: props.idpel.lng || '',
});

const submit = () => {
    form.put(route('idpels.update', props.idpel.id));
};
</script>

<template>
    <Head title="Edit IDPEL - SIPIJAR" />
        ...
        <main class="w-full pt-20 pb-12 bg-transparent px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto space-y-8">
            ...
            <section class="flex items-center gap-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl p-6 rounded-3xl shadow-sm border border-rose-100/70 dark:border-rose-950/50">
                ...
                <div class="flex flex-col">
                    <h1 class="font-headline-lg text-2xl font-extrabold text-gray-950 dark:text-white tracking-tight">Edit Data IDPEL</h1>
                    <p class="font-body-sm text-sm text-gray-500 dark:text-gray-400">Pembaruan master data pelanggan gardu PLN.</p>
                </div>
            </section>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input v-model="form.idpel_number" type="text" class="w-full bg-rose-50/40 dark:bg-rose-950/20 px-4 py-2.5 rounded-xl border border-rose-100/60 dark:border-rose-900/30 focus:border-primary focus:ring-1 focus:ring-primary transition-all font-label-md text-sm text-gray-900 dark:text-white" required />
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input v-model="form.name" type="text" class="w-full bg-rose-50/40 dark:bg-rose-950/20 px-4 py-2.5 rounded-xl border border-rose-100/60 dark:border-rose-900/30 focus:border-primary focus:ring-1 focus:ring-primary transition-all font-label-md text-sm text-gray-900 dark:text-white" required />
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <textarea v-model="form.address" rows="3" class="w-full bg-rose-50/40 dark:bg-rose-950/20 px-4 py-2.5 rounded-xl border border-rose-100/60 dark:border-rose-900/30 focus:border-primary focus:ring-1 focus:ring-primary transition-all font-label-md text-sm text-gray-900 dark:text-white"></textarea>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input v-model="form.lat" type="text" class="w-full bg-rose-50/40 dark:bg-rose-950/20 px-4 py-2.5 rounded-xl border border-rose-100/60 dark:border-rose-900/30 focus:border-primary focus:ring-1 focus:ring-primary transition-all font-label-md text-sm text-gray-900 dark:text-white" />
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input v-model="form.lng" type="text" class="w-full bg-rose-50/40 dark:bg-rose-950/20 px-4 py-2.5 rounded-xl border border-rose-100/60 dark:border-rose-900/30 focus:border-primary focus:ring-1 focus:ring-primary transition-all font-label-md text-sm text-gray-900 dark:text-white" />
                    ...
                    <div class="pt-4 flex justify-end gap-3">
                        ...
                        <button type="submit" :disabled="form.processing" class="inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-600 text-white px-6 py-2.5 rounded-xl font-label-md text-sm font-bold shadow-md shadow-amber-500/20 hover:shadow-lg transition-all disabled:opacity-70">
